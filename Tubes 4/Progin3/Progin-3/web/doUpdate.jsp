...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/progin_405_13510099","progin","progin");
 ...
 if (!isMultipart) {
     ...
     if (item.isFormField()) {
         ...
         try {
             ...
             String tQuery = "UPDATE user1 SET avatar='"itemName+"', tanggal_lahir='"+birth+"', nama_lengkap='"+namaLengkap+"', password='"+password+"'";
